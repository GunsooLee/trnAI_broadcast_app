...
| `category` | 대분류 카테고리 | 상품의 대분류 카테고리 | `"건강식품"` |
| `categoryMiddle` | 중분류 카테고리 | 상품의 중분류 카테고리 (선택) | `"다이어트/건강기능"` |
| `categorySub` | 소분류 카테고리 | 상품의 소분류 카테고리 (선택) | `"비타민/미네랄/영양제"` |
...
- 카테고리 다양성 제한: 같은 **대분류** 카테고리는 최대 4개까지만 추천됩니다
...
**⚠️ 배치 순서:**
- **타사 편성이 먼저** 배치됩니다 (경쟁사 분석 우선)
- **네이버 상품이 나중에** 배치됩니다 (트렌드 참고용)
  ...
  "recommendations": [
    {
      ...
      "productInfo": {
        ...
        "category": "건강식품",
        "categoryMiddle": "다이어트/건강기능",
        "categorySub": "비타민/미네랄/영양제",
        "brand": "헬스케어",
        "price": 99000,
        "tapeCode": "T001",
...
### Q7. 시즌에 맞지 않는 상품이 추천될 수 있나요?
- **아니오.** AI가 시즌 적합성을 엄격하게 검사합니다.
- **겨울철(11-2월)**: 여름 상품("냉감", "쿨", "SS" 등) 자동 제외
- **여름철(6-8월)**: 겨울 상품("난방", "보온", "FW" 등) 자동 제외
- **명절 불일치**: 지나간 명절이나 너무 이른 명절 상품 제외
- 상품명뿐만 아니라 **방송테이프명**까지 검사하여 더욱 정확합니다.

### Q8. 같은 카테고리 상품이 너무 많이 나올 수 있나요?
- **아니오.** 카테고리 다양성 제한이 있습니다.
- 같은 **대분류 카테고리**는 최대 4개까지만 추천됩니다.
- 같은 **카테고리+브랜드** 조합은 1개만 허용됩니다.
- 예: "건강식품" 카테고리는 최대 4개, 그 중 "건강식품+종근당"은 1개만 추천
