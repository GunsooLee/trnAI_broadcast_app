...
**예시:**
```
[경쟁사|뉴스] | [뉴스] '밍크코트' 트렌드 (출처: https://...) | [경쟁사대응] hmallplus '에이앤디 사가폭스 밍크카라 패딩코트' (08:00) 키워드:'사가폭스' | [예측매출] 1,770만원 | [점수] 총점 0.527

[과거실적] | [과거실적] 최근 2024-11-11 09:31 방송 매출 2,729만원 (평균 2,729만원, 1회) | [예측매출] 2,033만원 | [점수] 총점 0.363
```

**특징:**
- 복합 출처: 여러 출처에서 동시에 추천된 경우 `|`로 구분
- 경쟁사 정보: 방송사, 편성제목, 시간, 매칭 키워드 포함
- 과거실적 정보: 최근 방송일자, 시간, 매출, 평균매출, 방송횟수 포함
- 뉴스 정보: 트렌드 키워드 및 출처 URL 포함
